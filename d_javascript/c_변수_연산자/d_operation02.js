...
// true && true : true
//true && true && flase && true && true: false

//? cf) 자바스크립트 '단락 평가'
// : 논리 연산에서 첫 번재 피연산자 값만으로 해당 식의 결과가 확실할 때, 두 번재 값은 평가하지 않는 것
...
// +) 초기 JS 설계 결함으로 null 데이터의 타입은 object로 반환
