...
//! 1. 함수의 정의
// : 특정의 작업을 수행하거나 값을 계산하는 데 사용되는 코드의 묶음(집합)
...
let result2 = sum('홍', '길동');
console.log(result2); // 홍길동
...
//& 1) 함수 선언식: function 키워드 사용, 함수명 작성이 필수
...
//& 3) 화살표 함수: 기존의 fucntion 키워드를 화살표(=>)로 대체(간결한 작성)
//  >> '호이스팅' 적용 X
// +) 항상 익명함수로 작성
