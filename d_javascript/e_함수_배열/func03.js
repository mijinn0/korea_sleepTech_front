...
greet1(50); // 안녕하세요, 50님! undefined세 입니다.

function greet2(age, name='비회원 고객') {
  console.log(`안녕하세요, ${name}님! ${age}세 입니다.`);
}

greet2(50); // 안녕하세요, 비회원 고객님! 50세 입니다.
greet2(40, '홍길동'); // 안녕하세요, 홍길동님! 40세 입니다.

//! 2. 가변 매개변수: 함수 호출 시 인자 수 고정 X, 함수 내부에서 유동적으로 처리
...
// >> 데이터가 지정될 변수가 있는 매개 변수 목록들 보다 마지막에 위치
