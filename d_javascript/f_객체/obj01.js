...
//?  기능
// - 가속하다: '현재속도 증가' / 정지하다: '차량을 정지' / 경적을울라다: '경적을 울림'
...
// : 중괄호를 사용하여 객체를 선언하고 초기화 - 내부의 속성과 메서드 정의
...
function Human(nameParam, heigthtParam) {
  // this 키워드
  // : 해당 생성자 함수로 생성되는 객체 그 자체
  // - 각 객체마다 값이 달라짐

  this.name = nameParam;
  this.heigtht = heigthtParam;

  this.greet = function() { // 익명함수: 함수 표현식
    console.log(`Hello, ${this.name}`);
  }
}

let person1 = new Human('홍길동', 170);
let person2 = new Human('홍길순', 165);

console.log(person1.name);
console.log(person1.heigtht);
person1.greet(); // Hello, 홍길동

console.log(person2.name);
console.log(person2.heigtht);
person2.greet(); // Hello, 홍길순
