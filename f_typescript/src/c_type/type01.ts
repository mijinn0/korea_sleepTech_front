...
//& 3. void 타입
// : 아무런 값이 없다.
// - 주로 함수에서 반환값이 없거나, return 값이 있더라도 값이 없을 때 사용되는 타입

// funciton 함수명(파라미타: 타입): 반환타입 {}
...
// - JS는 각각의 타입으로 지정된 변수에는 각 타입만 할당 가능
// >> 어노테이션을 사용한 타입 강화 시!
...
//& 5. any 타입 (모든)
// : 모든 타입에 대해 허용하는 타입
// - 타입 검사 오류 방지를 위해 사용 (모든 타입과 효율 가능)
...
let numbers: Array<number> = [1, 2, 4, 8];
