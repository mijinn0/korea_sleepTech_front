...
// 객체의 속성값 수정
// 객체.속성 = 재할당값;
// readonlyUser.name = '홍길순';
// readonlyUser.age = 30; // 읽기 전용 속성이므로 'age'에 할당할 수 없습니다.
readonlyUser.address = '대전시';

console.log(readonlyUser); // { name: '홍길동', age: 29, address: '대전시' }