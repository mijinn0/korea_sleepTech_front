...
const student1 = new Student('류민석', 24);
student1.greet('이민형');
//Hello1, my name is 이민형
// Hello2, my name is 류민석

const student2 = new Student('이상혁', 30);
student2.greet('박의진');
// Hello1, my name is 박의진
// Hello2, my name is 이상혁
