...
const sortUsers = (users: UsersType, key: 'name' | 'email') => {
...
//! 8) 이벤트 리스너 추가 함수
// @Params: usrs - UsersType 타입
// @Return: X
const addEventListener = (users: UsersType): void => {
  const searchInput = document.getElementById('search-input') as HTMLInputElement; // as HTMLInputElement: 반드시 존재할거야!
