...
interface ConsoleProps {
  message: string;
  children: React.ReactNode; // HTML 요소 + 사용자 정의 컴포넌트 -> 화면에 출력되는 요소
}
    ...
    <div>
      ...
      */}
      ...
      {/* 
        ...
        2) -handler 끝
          : 이벤트 동작 이름 + handler
          EX) clickHandler, SignUpSubmitHandler, mouseEnterHander 등
      */}
