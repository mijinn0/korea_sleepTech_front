...
// >> y
// >> Project name: korea-sleepTech-react
// >> Package name: korea-sleeptech-react
// >> Select a framwork: React
// >> Select a variant: TypeScript
// korea_sleepTech-react 폴더 바깥으로 빼기
// g_react 폴더 삭제

// korea-sleepTech-react 통합터미널 열기
// >> npm install
// >> npm run dev
// >> ctrl 누르고, Local 주소 누르기
// >> 홈페이지에 count is 버튼 눌러서 숫자 변하는지 확인
...
// - 개발 주엥도 해당 파일을 기준으로 동작 (Vite가 해당 파일을 분석하여 앱 실행)